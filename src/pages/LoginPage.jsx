                ...
                >
                    <div className="w-full max-w-md space-y-7">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button className="flex items-center justify-center gap-2 p-3 rounded-full border border-zinc-700 hover:border-zinc-600 bg-transparent hover:bg-zinc-900/50 transition-all text-sm font-medium">
